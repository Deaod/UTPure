...
final function xxGetValues() //initial only
{
	...
	if (ConsoleWindow != None)
		ConsoleWindow.WindowTitle = class'UTPure'.Default.VersionStr$class'UTPure'.Default.ThisVer@"-"@ConsoleWindow.default.WindowTitle;
	...
	if (Root != None)	// Will not work properly if they joined directly without creatign the menu...
	{
		...
		{
			if (UMenuModMenuList(zzList) != None)

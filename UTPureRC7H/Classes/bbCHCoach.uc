...
exec function Hold()
{
	if (PlayerReplicationInfo.bAdmin && UTPure.zzAutoPauser != None)
		UTPure.zzAutoPauser.PlayerHold(PlayerReplicationInfo);
}

exec function Go()
{
	if (PlayerReplicationInfo.bAdmin && UTPure.zzAutoPauser != None)
		UTPure.zzAutoPauser.PlayerGo(PlayerReplicationInfo);
}
